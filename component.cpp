...
lost::lost(string &name0,string &category0,string &place0,tm *t) : lostTime(*t),state(1),lostTimeStamp(mktime(t)){
    strcpy(lostName,name0.c_str());
    strcpy(category,category0.c_str());
    strcpy(place,place0.c_str());
    strcpy(stuName,"未认领");//赋空值
    strcpy(stuId,"");
    strcpy(phoneNumber,"");
}
lost::lost():state(1){}
